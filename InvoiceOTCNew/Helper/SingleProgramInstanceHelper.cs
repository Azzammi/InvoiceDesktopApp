...
namespace InvoiceOTCNew.Helper
{
    ...
    public class SingleProgramInstanceHelper : IDisposable
    {
        ...
        public SingleProgramInstanceHelper()
        {
        ...
        public SingleProgramInstanceHelper(string identifier)
        {
            //Initialize a named mutex and attempt to
